...
{score=0;}}}
if(score!=0)
{found.push({"score":score,"title":tipuesearch_in.pages[i].title,"desc":s_t,"url":tipuesearch_in.pages[i].url,"src":tipuesearch_in.pages[i].src,"alt":tipuesearch_in.pages[i].alt});c++;}}}
else
...
{out+='<a href="'+found[i].url+'" class="card__link"><article class="card"><img class="card__image" src="'+found[i].src+'" alt="'+found[i].alt+'"><h3 class="card__heading">'+found[i].title+'</h3>';if(set.debug)
...
{t_d+=' ...';}
t_d=t_d.replace(/h0011/g,'span class=\"tipue_search_content_bold\"');t_d=t_d.replace(/h0012/g,'/span');out+='<div class="card__excerpt"><p>'+t_d+'</p></div></article></a>';}}
l_o++;}
