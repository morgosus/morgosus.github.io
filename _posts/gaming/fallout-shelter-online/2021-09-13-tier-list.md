...
<li id="the-inspector" class="tier tier--left tier--foso" role="listitem">
...
Additionally, if you draw these from pools, it will take this many successful pulls (not counting the wish pool)
